...
class tbl_poc_cmf_product_N4(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_Table(huemulBigDataGov, Control) with Serializable {
  ...
  val Prod_n4_desc: huemul_Columns = new huemul_Columns (StringType, true, "Prod_n4_desc")  
          .securityLevel(huemulType_SecurityLevel.Public)  

   val Prod_n3_id: huemul_Columns = new huemul_Columns (DecimalType(10,2), true, "Prod_n3_id")       
          .securityLevel(huemulType_SecurityLevel.Public)  
