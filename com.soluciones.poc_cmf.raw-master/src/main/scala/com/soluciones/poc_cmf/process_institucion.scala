...
object process_institucion {
  ...
  */
  def main(args : Array[String]) {
    //Creacion API
    val huemulBigDataGov  = new huemul_BigDataGovernance(s"Masterizacion tabla tbl_poc_cmf_institucion - ${this.getClass.getSimpleName}", args, globalSettings.Global)
  ...
  def process_master(huemulBigDataGov: huemul_BigDataGovernance, ControlParent: huemul_Control, param_ano: Integer, param_mes: Integer): huemul_Control = {
    ...
    try {             
      ...
      val huemulTable = new tbl_poc_cmf_institucion(huemulBigDataGov, Control)
