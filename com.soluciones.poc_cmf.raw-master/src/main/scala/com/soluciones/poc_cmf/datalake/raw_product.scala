 ...
 */
class raw_product(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
...
object raw_product {
  ...
  def main(args : Array[String]) {
    ...
    val DF_RAW =  new raw_product(huemulBigDataGov, Control)
