 ...
 */
class raw_activosbanco1_mes(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
   ...
   //configura el nombre del archivo (se pueden usar comodines)
      .setFileName("ab1{{YYYY}}{{MM}}_cmf.csv")
 ...
 */
object raw_activosbanco1_mes_test {
   /**
