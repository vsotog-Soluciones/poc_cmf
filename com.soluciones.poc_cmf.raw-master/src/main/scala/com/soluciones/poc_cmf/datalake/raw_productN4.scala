 ...
 */
class raw_product_N4(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
   ...
   //Forma detallada
     .addColumn("Prod_n4_id", "Prod_n4_id", DecimalType(10,0), "Prod_n4_id")
     .addColumn("Prod_n4_desc", "Pn4_desc", StringType, "Prod_n4_desc")
     .addColumn("Prod_n3_id", "Prod_n3_id", DecimalType(10,0) , "Prod_n3_id")   
...
object raw_product_N4 {
  ...
  def main(args : Array[String]) {
    ...
    val DF_RAW =  new raw_product_N4(huemulBigDataGov, Control)
