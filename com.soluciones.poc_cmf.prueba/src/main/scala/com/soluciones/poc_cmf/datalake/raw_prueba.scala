 ...
 */
class raw_prueba(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
...
object raw_prueba {
  ...
  def main(args : Array[String]) {
    ...
    val DF_RAW =  new raw_prueba(huemulBigDataGov, Control)
