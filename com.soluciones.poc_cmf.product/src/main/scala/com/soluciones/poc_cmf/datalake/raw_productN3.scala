 ...
 */
class raw_product_N3(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
   ...
   //Forma detallada
     ...
     .addColumn("Prod_n3_desc", "Prod_n3_desc", StringType, "Prod_n3_desc")
     .addColumn("Prod_n2_id", "Prod_n5_id", DecimalType(10,0) , "Prod_n2_id")    
