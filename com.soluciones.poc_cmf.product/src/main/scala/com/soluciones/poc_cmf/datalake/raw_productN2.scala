 ...
 */
class raw_product_N2(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
   ...
   //Forma detallada
     .addColumn("Prod_n2_id", "Prod_n2_id", DecimalType(10,0), "Prod_n2_id")
     .addColumn("Prod_n2_desc", "Prod_n2_desc", StringType, "Prod_n2_desc")
     .addColumn("Prod_n1_id", "Prod_n1_id", StringType , "Prod_n1_id")   
...
object raw_product_N2 {
  ...
  def main(args : Array[String]) {
    ...
    val DF_RAW =  new raw_product_N2(huemulBigDataGov, Control)
